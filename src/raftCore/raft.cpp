...
void Raft::doElection() {
    ...
    if (m_status != Leader) {
        ...
        for (int i = 0; i < m_peers.size(); i++) {
            ...
            std::shared_ptr<raftRpcProctoc::RequestVoteReply> requestVoteReply = std::make_shared<raftRpcProctoc::RequestVoteReply>();
...
bool
Raft::sendAppendEntries(int server, std::shared_ptr<raftRpcProctoc::AppendEntriesArgs> args, std::shared_ptr<raftRpcProctoc::AppendEntriesReply> reply,
...
void Raft::AppendEntries(google::protobuf::RpcController *controller, const ::raftRpcProctoc::AppendEntriesArgs *request,
...
void Raft::InstallSnapshot(google::protobuf::RpcController *controller, const ::raftRpcProctoc::InstallSnapshotRequest *request,
